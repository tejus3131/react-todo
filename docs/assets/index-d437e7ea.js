...
function Rd() {
  let e = JSON.parse(localStorage.getItem("todos") || "null");
  (!e || e === "null") &&
    (localStorage.setItem("todos", JSON.stringify([])), (e = []));
  const [n, t] = Lt.useState(""),
    [r, l] = Lt.useState(e);
  function o(s) {
    l(s), localStorage.setItem("todos", JSON.stringify(s));
  }
  function u() {
    if (n) {
      let s = !1;
  ...
  function i(s) {
    const c = r.filter((h) => h.id !== s);
    o(c);
  }
  return U.jsxs(U.Fragment, {
    children: [
      U.jsx("h1", {
        className: "p-3 text-center bg-dark text-white",
        children: "Todo List",
      }),
      U.jsxs("div", {
...
Ql.createRoot(document.getElementById("root")).render(
  U.jsx(wc.StrictMode, { children: U.jsx(Rd, {}) })
);
